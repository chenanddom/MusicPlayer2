...
public class MSlidingMenu extends ViewGroup {
    ...
    public MSlidingMenu(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MSlidingMenu(Context context, AttributeSet attrs, int defStyleAttr) {
